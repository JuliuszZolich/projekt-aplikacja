            ...
            <div className={"announcements-top-bar"}>
                <select name={"interval"} id="interval"
                    onChange={()=>{
                        ...
                        if(document.getElementById("interval").value==="oldest")
                            setFilteredPosts(prevPosts => {
                                return [...prevPosts].sort((a, b) => {
                                    return a.props['data-time'] - b.props['data-time'];
                                });
                            });
                        else if(document.getElementById("interval").value==="latest")
                            setFilteredPosts(prevPosts => {
                                return [...prevPosts].sort((a, b) => {
                ...
                <select name={"types"} id="types"
                    onChange={()=>{setFilteredPosts(filterPosts(announcementPosts));}}
                >
